...
class PurchaseFlowApiTest extends TestCase
{
    ...
    public function test_controller_has_required_actions(): void
    {
        ...
        $required = [
            ...
            'createContract','signContract','downloadContractFile','downloadPaymentVoucher',
    ...
    public function test_key_routes_present(): void
    {
        ...
        $must = [
            ...
            'GET /contracts/{id}/files/{fid}/download',
            'POST /payment-requests',
            'POST /payment-requests/{id}/approve',
            'GET /payment-requests/{id}/vouchers/{vid}/download',
            'POST /payments',
            'POST /shipments',
