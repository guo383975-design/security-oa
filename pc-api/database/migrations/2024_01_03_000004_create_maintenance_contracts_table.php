...
return new class extends Migration
{
    public function up(): void
    {
        ...
        Schema::create('maintenance_contracts', function (Blueprint $table) {
            ...
            $table->enum('inspection_frequency', ['monthly', 'quarterly', 'biannual', 'yearly'])->default('quarterly')->comment('巡检频率');
            $table->text('scope')->nullable()->comment('维保范围');
            $table->enum('status', ['active', 'expiring', 'expired', 'terminated'])->default('active')->comment('合同状态');
