...
Route::prefix('suppliers')->middleware(['auth:sanctum', 'ensure_business', 'permission:supplier.view'])->group(function () {
    ...
    Route::put('{id}', [SupplierController::class, 'update'])->whereNumber('id')->middleware('permission:supplier.create');
    Route::delete('{id}', [SupplierController::class, 'destroy'])->whereNumber('id')->middleware('permission:supplier.create');
    Route::post('{id}/change-status', [SupplierController::class, 'changeStatus'])->whereNumber('id')->middleware('permission:supplier.create');
    Route::post('{id}/sync-contacts', [SupplierController::class, 'syncContacts'])->whereNumber('id')->middleware('permission:supplier.create');
